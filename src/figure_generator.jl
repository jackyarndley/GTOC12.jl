...
while length(id_subset) < 200
    print("Size: $(length(id_subset)), last ID: $(id_subset[end])")

    temp = []

    for id in id_subset
        temp10 = all_ids[[minimum(norm.(eachcol(a .- asteroids_join_check[1:3, id, :]))) for a in eachslice(asteroids_join_check[1:3, :, :], dims=2)] .<= 0.018]
...
id_subset = [455, 775, 792, 899, 981, 998, 1395, 1509, 1574, 1708, 2032, 2174, 2202, 2311, 2356, 2420, 2890, 3196, 3241, 3302, 3306, 3351, 3713, 3797, 3896, 5085, 5095, 5501, 5707, 5738, 6239, 6437, 6856, 7352, 7802, 7831, 7976, 8064, 8201, 8432, 9070, 9196, 9260, 9745, 9825, 10084, 10229, 10711, 10981, 11527, 11605, 11721, 12053, 12386, 12628, 13655, 14299, 14684, 14788, 14854, 15083, 15153, 15184, 15372, 16356, 16488, 16821, 17227, 17983, 19432, 19434, 19702, 19906, 20732, 20862, 20943, 22108, 22246, 22404, 22459, 22483, 22612, 22937, 23056, 23183, 23438, 23483, 23795, 23987, 24025, 24443, 24483, 25119, 25279, 25453, 26228, 26375, 26396, 26426, 26525, 26913, 27278, 27464, 27917, 28090, 28116, 28289, 29218, 29390, 29481, 29530, 30383, 30533, 31059, 31342, 32088, 32248, 33386, 33588, 35178, 35307, 35403, 36243, 36295, 37049, 37117, 37322, 37747, 37818, 38027, 38128, 38508, 38534, 38554, 39557, 39584, 39862, 40101, 40322, 40804, 41045, 41150, 41270, 41505, 41806, 42135, 42697, 43836, 44566, 44982, 45162, 45733, 46418, 46431, 46502, 46555, 46751, 46990, 47258, 47630, 47674, 47817, 48748, 49031, 49053, 49124, 49334, 49349, 49522, 49726, 50040, 50715, 50972, 51591, 51614, 51629, 51831, 51864, 52066, 52775, 53339, 53488, 53498, 53592, 53871, 53908, 54260, 54872, 54893, 54905, 55868, 56398, 56399, 56703, 56866, 57913, 58468, 58680, 59575, 59994]
