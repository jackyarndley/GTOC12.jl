...
out = collect(1:60000)[(norm.(eachcol(ephemeris_cartesian_at(asteroids_classical, convert_mjd_to_time(65013))[1:3, :] .- ephermeris_cartesian_from_id(15184, convert_mjd_to_time(65013))[1:3, :])) .<= 0.2) .& (asteroids_classical[1, :] .>= 2.7) .& (asteroids_classical[1, :] .<= 2.9)]
...
id_subset = sort([15184, 3241, 2032, 53592, 46418, 19702, 23056, 46751, 32088, 23987][1:7])
